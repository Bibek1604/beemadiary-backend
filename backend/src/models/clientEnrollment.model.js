...
const shapeEnrollmentPayload = (payload = {}, files = {}) => ({
  personal_profile: {
    ...
    father_name: payload.father_name || payload.fatherName || null,
    mother_name: payload.mother_name || payload.motherName || null,
    grandfather_name: payload.grandfather_name || payload.grandfatherName || null,
...
const shapeClientRecord = (client) => {
  ...
  return {
    ...
    grandfather_name: client.grandfather_name,
